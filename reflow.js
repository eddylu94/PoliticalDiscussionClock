...
var reflow = function() {
	if (mobilecheck()) {
		...
		document.getElementById("history_link").innerHTML = "<img id=\"history_img\" src=\"ic_history_white_24dp_2x.png\" />";
		document.getElementById("history_link").style.height = "100px";
		document.getElementById("header_placeholder").style.height = "100px";
		document.getElementById("title").style.height = "100px";
		document.getElementById("title_left").style.height = "100px";
		document.getElementById("title_left").style.lineHeight = "100px";
		...
		document.getElementById("history_link").innerHTML = "History";
		document.getElementById("history_link").style.height = "50px";
		document.getElementById("header_placeholder").style.height = "50px";
		document.getElementById("title").style.height = "50px";
		document.getElementById("title_left").style.height = "50px";
		document.getElementById("title_left").style.lineHeight = "50px";
